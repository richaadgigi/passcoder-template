export default function Category(props){
    return (
        <svg width={props.width}  height={props.height}  viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg">
            ...
            <g id="Iconly/Light/Category" stroke="currentColor"  stroke-width="2"  fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round">
                <g id="Category" transform="translate(2.999141, 3.000000)" stroke="currentColor"  stroke-width="2" >
