            ...
            <section className="xui-dashboard">
                <div className="navigator xui-text-white xui-px-2 disable-scrollbars">
                    ...
                    <div className="links xui-pt-2">
                        ...
                        <Link to={`/${stripped}/announcements`} className={"xui-text-inherit link-box xui-font-sz-90 xui-opacity-6 menu-side " + (loc.pathname === `/${stripped}/announcements` || loc.pathname === `/${stripped}/announcement/add` ? 'active' : '')}>
                            <div className="icon">
